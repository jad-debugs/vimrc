Below is a summary from the plugins I use. Some are not included, but can easily be found because the plug name is their github repo. I obviously didnt write these, its from the respective creators.
